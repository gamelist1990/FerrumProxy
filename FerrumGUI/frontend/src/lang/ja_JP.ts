...
export const ja_JP: Translation = {
  ...
  targetHost: 'ターゲットホスト',
  enableTcpListener: 'TCPを有効化',
  enableUdpListener: 'UDPを有効化',
  protocolBothDisabled: 'TCPとUDPの両方が無効です。このリスナーは通信を受け付けません。',
  protocolScope: '適用プロトコル',
  protoBoth: 'TCP + UDP',
  protoTcpOnly: 'TCPのみ',
  protoUdpOnly: 'UDPのみ',
  ...
  letsEncryptDomains: 'Let\'s Encrypt ドメイン（カンマ区切り）',
  letsEncryptEmail: 'Let\'s Encrypt 通知メール',
  autoProvisionLetsEncrypt: '証明書がなければ自動取得',
  checkAndProvisionLetsEncrypt: '証明書を確認・取得',
  letsEncryptProvisioning: '証明書を確認中...',
  letsEncryptProvisionHint: '同じIPで扱う複数ドメインをカンマ区切りで指定すると、1つのSAN証明書へまとめて取得します。',
  letsEncryptDomainRequired: 'ドメインを1件以上入力してください。',
  letsEncryptAlreadyPresent: '証明書は既に存在します。',
  letsEncryptProvisionSuccess: 'Let\'s Encrypt証明書を取得しました。',
  letsEncryptProvisionFailed: 'Let\'s Encrypt証明書の取得に失敗しました:',
  ...
  performancePersisted: '再起動後も累計データを保持しています',
  performanceLiveOnly: 'ライブデータ',
  clearPerformanceCache: 'キャッシュ削除',
  clearPerformanceConfirm: '保存されたパフォーマンス累計と位置情報キャッシュを削除しますか？',
  persistentTotal: '永続累計',
  currentProcess: '現在のプロセス',
  connectionAnalytics: '接続分析',
  ipRecordingEnabled: 'IP記録から集計',
  ipRecordingDisabled: 'IP記録は無効です',
  recordedConnections: '記録済み接続',
  uniqueIps: 'ユニークIP',
  enableIpRecordingHint: '設定で「IPの記録」を有効にすると、接続ランキングと世界分布を表示します。',
  worldConnectionMap: '接続ワールドマップ',
  worldMapHint: '色の強さは国別の接続回数を表します',
  topConnectionIps: 'Top 接続IP',
  rankedByConnections: '接続回数順',
  connections: '接続',
  unknownLocation: '位置情報なし',
  locationPending: '公開IPの位置情報を順次取得しています',
  noIpRecords: 'IP記録はまだありません。',
  showForm: 'フォーム表示',
  showJson: 'JSON表示',
