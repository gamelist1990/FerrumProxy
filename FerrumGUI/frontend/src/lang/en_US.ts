export const en_US = {
  ...
  letsEncryptDomains: 'Let\'s Encrypt Domains (comma-separated)',
  letsEncryptEmail: 'Let\'s Encrypt Email',
  autoProvisionLetsEncrypt: 'Automatically issue missing certificate',
  checkAndProvisionLetsEncrypt: 'Check and Issue Certificate',
  letsEncryptProvisioning: 'Checking certificate...',
  letsEncryptProvisionHint: 'Comma-separated domains on the same IP are issued together as one SAN certificate.',
  letsEncryptDomainRequired: 'Enter at least one domain.',
  letsEncryptAlreadyPresent: 'The certificate already exists.',
  letsEncryptProvisionSuccess: 'Let\'s Encrypt certificate issued successfully.',
  letsEncryptProvisionFailed: 'Let\'s Encrypt certificate issuance failed:',
  ...
  performancePersisted: 'Cumulative data is retained across restarts',
  performanceLiveOnly: 'Live data',
  clearPerformanceCache: 'Clear cache',
  clearPerformanceConfirm: 'Clear persisted performance totals and location cache?',
  persistentTotal: 'Persisted total',
  currentProcess: 'Current process',
  connectionAnalytics: 'Connection analytics',
  ipRecordingEnabled: 'Aggregated from IP records',
  ipRecordingDisabled: 'IP recording is disabled',
  recordedConnections: 'Recorded connections',
  uniqueIps: 'Unique IPs',
  enableIpRecordingHint: 'Enable IP recording in settings to show connection rankings and world distribution.',
  worldConnectionMap: 'Connection world map',
  worldMapHint: 'Color intensity represents connections by country',
  topConnectionIps: 'Top connection IPs',
  rankedByConnections: 'Ranked by connections',
  connections: 'connections',
  unknownLocation: 'Unknown location',
  locationPending: 'Public IP locations are being resolved',
  noIpRecords: 'No IP records yet.',
  showForm: 'Show Form',
  showJson: 'Show JSON',
